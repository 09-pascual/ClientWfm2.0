      ...
      {filteredProjects.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredProjects.map((project) => (
            <div
              key={project.id}
              className="bg-white border border-gray-200 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-200 flex flex-col justify-between"
            >
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-sm text-gray-700">
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{project.expected_duration} days</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{project.client.first_name}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4">
                <Link 
                  ...
                  className="w-full inline-block text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-150"
                >
                  Edit Project
                </Link> 
              </div>
